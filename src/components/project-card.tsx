    ...
    <div className="border border-gray-800 p-6 transition-colors hover:border-blue-500/50">
      <Link href={href} target="_blank" className="group">
        <div className="flex justify-between items-start mb-4">
          ...
          <ArrowUpRight className="w-5 h-5 text-gray-400 group-hover:text-blue-500 transition-all duration-200 group-hover:translate-x-1 group-hover:-translate-y-1" />
        </div>
      </Link>
